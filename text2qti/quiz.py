...
start_patterns = {
    ...
    'group_pick': r'[Pp]ick:',
    'group_solutions_pick': r'[Ss]olutions [Pp]ick:',
    'group_points_per_question': r'[Pp]oints [Pp]er [Qq]uestion:',
    'start_code': r'```+\s*\S.*',
    'end_code': r'```+',
    'quiz_shuffle_answers': r'[Ss]huffle [Aa]nswers:',
    'quiz_show_correct_answers': r'[Ss]how [Cc]orrect [Aa]nswers:',
    'quiz_one_question_at_a_time': r'[Oo]ne [Qq]uestion at a [Tt]ime:',
    'quiz_cant_go_back': r'''[Cc]an't [Gg]o [Bb]ack:''',
    'quiz_feedback_is_solution': r'[Ff]eedback is [Ss]olution:',
    'quiz_solutions_sample_groups': r'[Ss]olutions [Ss]ample [Gg]roups:',
    'quiz_solutions_randomize_groups': r'[Ss]olutions [Rr]andomize [Gg]roups:',
}
